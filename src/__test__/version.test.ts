...
/*
  Test that textile is downloaded during npm install.
...
describe.skip('textile package.json version', () => {
  ...
  it('should use the textile.version defined in parent package.json', () => {
    ...
    const msg = `Downloading https://github.com/textileio/textile/releases/download/${testVersion}`
